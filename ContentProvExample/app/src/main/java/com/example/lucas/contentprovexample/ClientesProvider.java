...
public class ClientesProvider extends ContentProvider {
    ...
    //Se creo aca la clase para mas simplicidad de codigo, y no en una clase aparte.
    ...
    //Base de datos
    private ClientesSQLHelper clidbh;
    ...
    public boolean onCreate() {
        clidbh = new ClientesSQLHelper(getContext(), BD_NOMBRE, null, BD_VERSION);
        return true;
    }
